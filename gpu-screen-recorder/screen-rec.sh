...
# --- Configuration ---
# NOTE: Ensure this path is correct and accessible.
CONFIG_FILE="$HOME/dotfiles/gpu-screen-recorder.conf"
OUTPUT_DIR="$HOME/Videos"
OUTPUT_FILE="$OUTPUT_DIR/recording_$(date +%F_%H-%M-%S).mp4"
FPS=60

# --- 1. Get and Reformat the Window Geometry ---
...
# IMPORTANT: Press Ctrl + C in the terminal to stop the recording.
